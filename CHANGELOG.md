...
- chore: Adopt standard CI workflows ([#129](https://github.com/MetaMask/eth-json-rpc-infura/pull/129))
- chore: Upgrade to Yarn v4 ([#128](https://github.com/MetaMask/eth-json-rpc-infura/pull/128))
